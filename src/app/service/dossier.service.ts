...
export class DossierService {
 ...
 private listUrl  = 'https://cmeapp.sarpi-dz.com/blacklist';
  ...
  getAlllDossiers(): Observable<any[]> {
    return this.http.get<any[]>(`https://cmeapp.sarpi-dz.com/api/decisions/dossiers-sans-decision`,{withCredentials: true});
  }
  ...
  ajouterResultatEtCompteRendu(idDossier: number, resultat: string, compteRendu: string) {
    ...
    return this.http.post(
      `https://cmeapp.sarpi-dz.com/api/resultats/dossiers/${idDossier}/resultat`,
      null,  // pas de body
  ...
  getResultatByDossierId(dossierId: number) {
    return this.http.get<any>(`https://cmeapp.sarpi-dz.com/api/resultats/dossiers/${dossierId}/resultat`, {withCredentials: true });
  }
  ...
  ajouterDecision(idDossier: number, decision: string, compteRendu?: string) {
    ...
    return this.http.post(
      `https://cmeapp.sarpi-dz.com/api/decisions/dossiers/${idDossier}/ajouter`,
      null,
      { params: params, withCredentials: true }
    );
  }
  ...
  getVisaRefusDecisions(): Observable<Dossier[]> {
    return this.http.get<Dossier[]>(`https://cmeapp.sarpi-dz.com/api/decisions/decision/Refus de visa`, { withCredentials: true });
  }
  getVisaSansReserveDecisions(): Observable<Dossier[]> {
    return this.http.get<Dossier[]>(`https://cmeapp.sarpi-dz.com/api/decisions/decision/Visa sans réserve`, { withCredentials: true });
  }
  ...
  getVisaSansREserveSuspDecisions(): Observable<Dossier[]> {
    return this.http.get<Dossier[]>(`https://cmeapp.sarpi-dz.com/api/decisions/decision/Visa sans réserve sunsponsive`, { withCredentials: true });
  }
  ...
  ajouterRendezVous(id: number, data: { dateHeureReunion: string }): Observable<any> {
    ...
    return this.http.post(
      `https://cmeapp.sarpi-dz.com/api/reunions/dossiers/${id}/ajouter`,
