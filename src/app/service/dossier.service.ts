...
export class DossierService {
  private apiUrl = 'https://cmeapp.sarpi-dz.com:8085/api/dossiers';
  private passationUrl = 'https://cmeapp.sarpi-dz.com:8085/api/passations'; // API pour Enum
  private  pdfUrl = 'https://cmeapp.sarpi-dz.com:9091/generate-merged-files-pdf';
 private listUrl  = 'https://cmeapp.sarpi-dz.com:8086/blacklist';
  ...
  getDossierByIdd(id: number): Observable<any> {
    return this.http.get<any>(`https://cmeapp.sarpi-dz.com:8085/api/decisions/dossiers/{{id}}`,{withCredentials: true});
  }
  ...
  getAllDossierswithout(): Observable<any[]> {
    return this.http.get<any[]>(` https://cmeapp.sarpi-dz.com:8085/api/resultats/dossiers-sans-mon-resultat`,{withCredentials: true});
  }

  getAlllDossiers(): Observable<any[]> {
    return this.http.get<any[]>(`https://cmeapp.sarpi-dz.com:8085/api/decisions/dossiers-sans-decision`,{withCredentials: true});
  }
  ...
  getStatsParEtat(): Observable<{ [key: string]: number }> {
    return this.http.get<{ [key: string]: number }>('https://cmeapp.sarpi-dz.com:8085/api/dossiers/stats/etat');
  }
  ajouterResultatEtCompteRendu(idDossier: number, resultat: string, compteRendu: string) {
    ...
    return this.http.post(
      `https://cmeapp.sarpi-dz.com:8085/api/resultats/dossiers/${idDossier}/resultat`,
      null,  // pas de body
  ...
  getResultatByDossierId(dossierId: number) {
    return this.http.get<any>(`https://cmeapp.sarpi-dz.com:8085/api/resultats/dossiers/${dossierId}/resultat`, {withCredentials: true });
  }

  getAllResultatsByDossierId(id: number) {
    return this.http.get<any[]>(`https://cmeapp.sarpi-dz.com:8085/api/resultats/dossiers/${id}/resultats`, {withCredentials: true });
  }
  ...
  ajouterDecision(idDossier: number, decision: string, compteRendu?: string) {
    ...
    return this.http.post(
      `https://cmeapp.sarpi-dz.com:8085/api/decisions/dossiers/${idDossier}/ajouter`,
      null,
      { params: params, withCredentials: true }
    );
  }
  ...
  getVisaRefusDecisions(): Observable<Dossier[]> {
    return this.http.get<Dossier[]>(`https://cmeapp.sarpi-dz.com:8085/api/decisions/decision/Refus de visa`, { withCredentials: true });
  }
  getVisaSansReserveDecisions(): Observable<Dossier[]> {
    return this.http.get<Dossier[]>(`https://cmeapp.sarpi-dz.com:8085/api/decisions/decision/Visa sans réserve`, { withCredentials: true });
  }
  getVisaAvecREserveSuspDecisions(): Observable<Dossier[]> {
    return this.http.get<Dossier[]>(`https://cmeapp.sarpi-dz.com:8085/api/decisions/decision/Visa avec réserve suspensive`, { withCredentials: true });
  }
  getVisaSansREserveSuspDecisions(): Observable<Dossier[]> {
    return this.http.get<Dossier[]>(`https://cmeapp.sarpi-dz.com:8085/api/decisions/decision/Visa sans réserve sunsponsive`, { withCredentials: true });
  }
  ...
  ajouterRendezVous(id: number, data: { dateHeureReunion: string }): Observable<any> {
    ...
    return this.http.post(
      `https://cmeapp.sarpi-dz.com:8085/api/reunions/dossiers/${id}/ajouter`,
